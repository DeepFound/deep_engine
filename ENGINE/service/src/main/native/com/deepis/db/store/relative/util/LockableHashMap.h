 ...
 */
#ifndef COM_DEEPIS_DB_STORE_RELATIVE_UTIL_LOCKABLEHASHMAP_H_
#define COM_DEEPIS_DB_STORE_RELATIVE_UTIL_LOCKABLEHASHMAP_H_ 
...
class LockableHashMap : public HashMap<K, V> /*, public Lockable */ {
	...
	protected:
		virtual int resize(int minused) {
			...
			{
				size = HashMap<K,V>::resize(minused);
			}
	...
	public:
		LockableHashMap(void) :
			m_resizeLock(false) {
		}

		LockableHashMap(int initialCapacity, boolean deleteValue, boolean resizeLock = false):
			HashMap<K,V>(initialCapacity, deleteValue),
...
#endif /*COM_DEEPIS_DB_STORE_RELATIVE_UTIL_LOCKABLEHASHMAP_H_*/
